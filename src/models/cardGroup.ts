...
export class CardGroup {
   ...
   * If card isn't in group, return is -1
  ...
  public remove(card: Card) {
    ...
    if (cardIndex !== -1) {
      ...
      throw new CardNotFoundError(`${card.toString()} not in group.`);
    }
  }
  ...
  public removeMany(cards: Card[]) {
    ...
    if (this.allCardsInGroup(cards)) {
      ...
      throw new CardNotFoundError('At least one card to remove not in group');
    }
  }
   ...
   * @param card
   * @param target
   * @throws CardNotFoundError generated by remove
   */
   ...
   * @param group
   * @param target
   * @throws CardNotFoundError generated by removeMany
   */
  /* TODO: If not used, remove; if used, write tests/error tests
